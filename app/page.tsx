  ...
  const services = [
    {
      ...
      title: 'Siti Web Flash',
      description: 'Siti professionali da 199€, online in 24 ore. Perfetti per piccole attività.',
      href: '/siti-web',
    ...
    },
    {
      ...
      description: 'Sviluppo applicazioni su misura con tecnologie AI-native.',
      href: '/software-ai',
    ...
    },
    {
      ...
      description: 'Chatbot, script e automazioni per semplificare il tuo business.',
      href: '/software-ai',
  ...
  const benefits = [
    {
      ...
      description: 'Consegna in 24 ore grazie al Vibe Coding e AI.'
    },
    {
      icon: <DollarSign className="w-6 h-6" />,
      title: 'Prezzi Imbattibili',
      description: 'Siti da 199€. Automazioni da 99€. Qualità professionale.'
    },
    {
      icon: <Rocket className="w-6 h-6" />,
      title: 'Tech All\'Avanguardia',
      description: 'Next.js, React, AI. Le migliori tecnologie del momento.'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-fuchsia-100 border border-fuchsia-300 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm text-fuchsia-700 font-medium">AI-Native Tech Agency</span>
            </div>
            
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-gray-900">
              Sviluppo Web e Software{' '}
              <span className="gradient-text">alla velocità dell'AI</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Grazie al <span className="text-fuchsia-600 font-semibold">Vibe Coding</span> abbattiamo costi e tempi. 
              Tu risparmi, noi consegniamo in 24 ore.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">
              Soluzioni AI-native per far crescere il tuo business
            </p>
          </div>
      ...
      <section className="gradient-bg py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Contattaci oggi e ricevi il tuo sito o la tua automazione entro 24 ore.
          </p>
          <Link 
            href="/contatti"
