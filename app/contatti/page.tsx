              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {submitStatus === 'success' && (
                    <div className="bg-green-50 border-2 border-green-500 text-green-800 px-4 py-4 rounded-lg flex items-start animate-fade-in">
                      <svg className="w-6 h-6 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                      </svg>
                      <div>
                        <p className="font-bold text-lg">Grazie! Ti risponderemo in 24h</p>
                        <p className="text-sm mt-1">Abbiamo ricevuto il tuo messaggio e ti contatteremo presto.</p>
                      </div>
                    </div>
                  )}
                  ...
                  {submitStatus === 'error' && (
                    <div className="bg-red-50 border-2 border-red-500 text-red-800 px-4 py-4 rounded-lg flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm mt-1">Riprova o contattaci via WhatsApp: +39 344 137 8445</p>
                      </div>
                    </div>
                  )}
